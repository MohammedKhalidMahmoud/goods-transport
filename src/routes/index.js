...
const serviceCategoriesRoutes = require('../modules/service-categories/service-categories.routes');
const serviceCategoriesAdminRoutes = require('../modules/service-categories/service-categories.admin.routes');
const serviceTypesRoutes = require('../modules/service-types/service-types.routes');
const serviceTypesAdminRoutes = require('../modules/service-types/service-types.admin.routes');
const vehicleTypesRoutes = require('../modules/vehicle-types/vehicle-types.routes');
const vehicleTypesAdminRoutes = require('../modules/vehicle-types/vehicle-types.admin.routes');
...
router.use('/dashboard', serviceCategoriesAdminRoutes);
router.use('/dashboard', serviceTypesAdminRoutes);
router.use('/dashboard', vehicleTypesAdminRoutes);
